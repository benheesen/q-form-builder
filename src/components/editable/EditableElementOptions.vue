<template>
  <form v-if="value" v-on:submit.prevent>
    ...
    <q-input dense v-model="value.label" placeholder="Label" :label="$t('surveys.label_to_display')" />
    ...
    <q-input dense v-model="value.field_options.description" type="textarea" :label="$t('surveys.longer_description')" filled />
    <q-toggle v-model="value.required" :label="$t('surveys.required')" v-if="ifNotTypes(['section_break', 'page_break'])" />
